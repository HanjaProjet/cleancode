...
public class CustomerTest {
    ...
    public void statementWithOneRegularMovieRental() {
        ...
        Customer me = new Customer("jeremie");
        Movie backToTheFutur = new Movie("Back to the futur", MovieCategory.REGULAR);
    ...
    public void statementWithOneNewReleaseMovieRental() {
        ...
        Customer me = new Customer("jeremie");
        Movie starWars8 = new Movie("star wars 8", MovieCategory.NEW_RELEASE);
    ...
    public void statementWithOneChildreneMovieRental() {
        ...
        Customer me = new Customer("jeremie");
        Movie ouiOui = new Movie("oui oui", MovieCategory.CHILDREN);
